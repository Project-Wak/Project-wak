...
{
var can_not_play = 0
	if (global.n_sword = 6 && (argument0 = swing_lightsaber_sfx1 || argument0 = swing_lightsaber_sfx2 || argument0 = swing_lightsaber_sfx3)) || global.slow_motion > 0 || audio_is_playing(ending_cinematic) || audio_is_playing(ending_cinematic_replay)
	{
	can_not_play = 1
	}
