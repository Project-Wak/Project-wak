...
global.show_guide_mes = "회피 및 가드\n\n가드시 상대 공격의 공격력에 비례하여 체력 대신 스테미나가 소모되며,\n스테미나가 부족한 경우, 가드가 되지 않는다.\n또한 순간적인 반속으로 적의 공격을 가드후,\n즉시 "+string(global.a_key)+"키(일반공격)를 누르게 되면, 패링이 된다.\n\n구르기시, 대부분의 공격을 피할수 있다\n\n이외에 적에게 데미지를 입은 경우, 플레이어가 피격상태가 되는데\n이때, 땅 위에서 빠르게 '구르기' 혹은 'Space키'를 눌러주면\n빠르게 피격상태를 캔슬할 수 있다."
