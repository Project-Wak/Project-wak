...
if image_index > 2
{
	...
	image_alpha = 0.6
	alpha = 1
	var a___ = audio_play_sound(lightning_sec_sfx,0,0)
	audio_sound_gain(a___,0.33*global.master_volume*2*global.sfx_volume,0)
...
var yy = other.y - s_y
	...
	{
	draw_sprite_ext(sprite_index,floor(image_index),xx-i,yy,image_xscale,image_yscale,image_angle,$FF75F2FF,image_alpha*0.015*i)
	draw_sprite_ext(sprite_index,floor(image_index),xx+i,yy,image_xscale,image_yscale,image_angle,$FF75F2FF,image_alpha*0.015*i)
	draw_sprite_ext(sprite_index,floor(image_index),xx,yy-i,image_xscale,image_yscale,image_angle,$FF75F2FF,image_alpha*0.015*i)
	draw_sprite_ext(sprite_index,floor(image_index),xx,yy+i,image_xscale,image_yscale,image_angle,$FF75F2FF,image_alpha*0.015*i)
	}
