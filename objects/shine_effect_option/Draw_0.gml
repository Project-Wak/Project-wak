...
var yy = camera_get_view_y(view_camera[0])+(160+64+64+48+32+90)*_c_x

image_index = global.shine_ef

draw_sprite_ext(sprite_index,image_index,xx,yy,image_xscale,image_xscale,0,c_white,1)
draw_text_kl_scale(xx+32*_c_x,yy-10*_c_x,"화면 번쩍임 효과 끄기",32,9999,0.8,image_blend,0,-1,font0,1/3*_c_x,1/3*_c_x,image_angle)
}