...
var console_key = keyconverter(global.use_item)
var img_ind__ = 0
...
draw_text_kl_scale(xx+32*_c_x,yy-10*_c_x,"아이템 사용",16,999,0.8,image_blend,0,-1,font0,1/3*_c_x,1/3*_c_x,image_angle)
}