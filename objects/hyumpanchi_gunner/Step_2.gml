...
if place_meeting(x,y,effect) && spin = 0
{
	if hit_cooltime = 0
	{
...
if place_meeting(x,y,effect_jump_attack) && spin = 0
{
	if hit_cooltime = 0
	{
...
if place_meeting(x,y,effect_down_attack) && spin = 0
{
	if hit_cooltime = 0
	{
...
if place_meeting(x,y,effect_attack1) && spin = 0
{
	if hit_cooltime = 0
	{
...
if place_meeting(x,y,effect_attack2) && spin = 0
{
	if hit_cooltime = 0
	{
...
if place_meeting(x,y,effect_attack3) && spin = 0
{
	if hit_cooltime = 0
	{
...
if place_meeting(x,y,effect_attack4) && spin = 0
{
	if hit_cooltime = 0
	{
...
if place_meeting(x,y,effect_attack_s) && spin = 0
{
	if hit_cooltime = 0
	{
...
if (place_meeting(x,y,rage_mode_knockback) || place_meeting(x,y,down_effect)) && spin = 0
{
	if hit_cooltime = 0
	{
	alarm[5] = 200
...
if place_meeting(x,y,ef_blood_dash_attack) && spin = 0
{
	if hit_cooltime = 0
	{
...
if place_meeting(x,y,charging_attack) && spin = 0
{
	if hit_cooltime = 0
	{
...
if place_meeting(x,y,effect_special_skill_sec) && spin = 0
{
	if hit_cooltime = 0
	{
...
if place_meeting(x,y,effect_special_skill) && spin = 0
{
	if hit_cooltime = 0
	{
