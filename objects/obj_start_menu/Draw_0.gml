...
if go_start >= 3
{
message_1 = "하드 코어\n\n[보스들의 공격에 대부분 즉사하며, 이외의 다른 부가적인 난이도 상승이 적용된다]\n\n(다회차 플레이어에게 추천)"
message_2 = "매우 어려움\n\n[난이도가 매우 어려워 진다]\n\n(소울라이크에 자신있는 혹은 다회차 플레이어에게 추천)"
message_3 = "어려움\n\n[난이도가 조금 어려워 진다]\n\n(매우 어려움은 싫지만, 보통도 싫은 사람에게 추천)"
message_4 = "보통\n\n[아무런 보정치도 없다]\n\n(게임 자체 난이도가 높은 편이기 때문에, 처음 해보는 사람에게 추천)"
message_5 = "쉬움\n\n[첫 시작시 강력한 특수 탈리스만를 얻으며, 이외에 난이도를 낮추는 여러 부가적인 보정이 적용된다]"
message_6 = "매우 쉬움\n\n[첫 시작시 강력한 특수 탈리스만를 얻으며, 이외에 난이도를 낮추는 여러 부가적인 보정이 적용된다]\n\n(라이트 유저에게 추천)"
scale__ = 2.2
scale__sec = 1.7
text_scale = 0.75
...
draw_text_kl_scale(xx+wid*0.5,yy-v_x*(global.show_credits-940),"Credits"+string(global.credit_message)+"\n\n\n\n\n\n\n\n(아무키나 눌러 나가기)",200,-1,alpha,c_white,0,0,font_title,v_x/5,v_x/5,0)
