...
if (pressed > 0 && global.key_setting_message > 0) || global.key_setting_message = 0
{
	...
	item_desc__ = "검성의 그림자는 매우 강력한 몹이지만, 굳이 처치 하지 않고도 게임 진행이 가능하다.\n다만, 검성의 그림자를 처치 할 경우 '특수한 무기'를 드랍한다."
	}
	if cal__img = 7
	{
