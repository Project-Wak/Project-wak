...
if (pressed > 0 && global.key_setting_message > 0) || global.key_setting_message = 0
{
	...
	item_desc__ = "검성의 그림자는 플레이어를 흉내내는 매우 강력한 몹이지만, 굳이 처치하지 않고도 게임 진행이 가능하다.\n다만, 검성의 그림자를 처치할 경우 '특수한 무기'를 드랍한다.\n\n(tip : 검성의 그림자가 레이지 모드를 사용하는 경우\n 되도락 레이지 모드가 끝날 때까지 도망다니자)"
	}
	if cal__img = 7
	{
