...
draw_sprite_ext(sprite_index,1,x+(player.x-x)/50,y+(player.y-y)/100,image_xscale,image_yscale,image_angle,image_blend,image_alpha)

if patturn > 1
{
draw_sprite_ext(sprite_index,2,x+(player.x-x)/50,y+(player.y-y)/100,image_xscale,image_yscale,image_angle,image_blend,image_alpha*(abs(patturn-1.65))/0.5)
}
draw_self()
