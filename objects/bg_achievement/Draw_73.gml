...
draw_sprite_ext(sprite_index,0,xx,yy,v_x_,v_x_*0.75,0,c_white,image_alpha)
draw_sprite_ext(sprite_index,1,xx,yy,v_x_,v_x_*0.75,0,$FF2B1F1A,image_alpha)
draw_sprite_ext(sprite_index,2,xx,yy,v_x_,v_x_*0.75,0,$FF19120F,image_alpha)
