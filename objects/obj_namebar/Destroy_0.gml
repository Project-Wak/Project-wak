...
var second_testers = "댐쿵이 BackSang 모니타리 스즈메의 문단속 벤찌 별명1577 Kastle 고 라니임니다 재영이요 윤석 러머 최민우 ㅁㅈ 허미온 아리에스 NAㅅ Mang0_k Ladon TJD ajdkg296 쥬기 잠복근무 도트박스 재영 윤석 허미온 cccc 원시인 징버거의 돗대 면주바이 뱌밍 "
...
var last_debugers = "뱌밍 우소 libertad 랑 이 갱후니 러머 ajdkg296 Hermione 대충지은닉네임 ㅇㅅㄹㅋ "
...
if (string_pos(global.nickname,last_debugers) != 0)
{
	if cre_achievement = 0
	{
	var _achievement = instance_create_depth(x,y,depth,bg_achievement)
	_achievement.text = "마지막 디버그 테스터 참여 감사합니다!"
	_achievement.icon_num = 0
	}
give_item(1,23)
cre_achievement = 1
